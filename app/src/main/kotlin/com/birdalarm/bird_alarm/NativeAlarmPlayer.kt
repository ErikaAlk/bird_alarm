        ...
        try {
            ...
            try {
                ...
                if (assetPath.startsWith("/") && localFile.exists()) {
                    ...
                    val descriptor = appContext.assets.openFd(assetPath.removePrefix(BirdAlarmAssets.LEGACY_PREFIX))
                ...
                try {
                    ...
                    appContext.assets.open(assetPath.removePrefix(BirdAlarmAssets.LEGACY_PREFIX)).use { input ->
